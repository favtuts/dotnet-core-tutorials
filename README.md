...
# list of articles
* [Debugging Multiple .NET Projects in VS Code](./vscode-multi-projects/README.md)
* [Implement Mediator Pattern with MediatR in C#](./mediator-pattern-impl/README.md)
